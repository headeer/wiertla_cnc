/******/ (function (modules) {
  ...
  /******/ function jsonpScriptSrc(chunkId) {
    /******/ return (
      ...
      "assets/" +
      ({ 1: "product-image-zoom", 5: "vendors--product-image-zoom" }[chunkId] ||
        chunkId) +
      ".min.js"
    );
    /******/
  ...
  /******/
  /******/ var jsonpArray = (window["baselineWebpackJsonp"] =
    window["baselineWebpackJsonp"] || []);
        ...
        return /******/ (() => {
          ...
          /******/ var __webpack_modules__ = {
            /***/ 311: /***/ (
               ...
               */
              /* harmony default export */ const state = function (
                initialState
              ) {
                /**
              ...
              /* harmony default export */ const slide = function (
                Splide,
                Components
              ) {
                /**
              ...
              /* harmony default export */ const fade = function (
                Splide,
                Components
              ) {
                var Fade = {
   ...
   * @return {number} - The current slide index.
   // */
                ...
                function (Splide, Components) {
                  ...
                  var Elements = {
                    ...
                    register: function register(slide, index, realIndex) {
                      var SlideObject = elements_slide(
                        Splide,
                        index,
                        realIndex,
                        slide
                  ...
                  function findParts(className) {
                    return (
                      child(root, className) ||
                      child(Elements.slider, className)
                    );
                  }
              ...
              /* harmony default export */ const controller = function (
                ...
                var Controller = {
                  ...
                  toIndex: function toIndex(page) {
                    ...
                    index =
                      index -
                      (this.pageLength * perPage - length) *
                        floor(index / length); // Adjustment for the last page.
                  ...
                  get nextIndex() {
                    ...
                    return (Splide.index < next && next <= this.edgeIndex) ||
                      next === 0
                      ? next
                      : -1;
                  },
              ...
              /* harmony default export */ const track = function (
                ...
                var Track = {
                  ...
                  trim: function trim(position) {
                    ...
                    var edge =
                      sign * (Layout.totalSize() - Layout.size - Layout.gap);
                  ...
                  toIndex: function toIndex(position) {
                    ...
                    Elements.getSlides(true).forEach(function (Slide) {
                      ...
                      var distance = abs(
                        _this2.toPosition(slideIndex) - position
                      );
                  ...
                  toPosition: function toPosition(index) {
                    var position =
                      Layout.totalSize(index) -
                      Layout.slideSize(index) -
                      Layout.gap;
                  ...
                  get position() {
                    ...
                    return (
                      getRect(list)[prop] -
                      (getRect(Elements.track)[prop] -
                        Layout.padding[prop] * sign)
                    );
                  },
                };
                /**
              ...
              /* harmony default export */ const clones = function (
                Splide,
                Components
              ) {
                /**
                ...
                function getCloneCount() {
                  ...
                  var baseCount =
                    options.autoWidth || options.autoHeight
                      ...
                      : options.perPage;
                  var dimension =
                    options.direction === TTB ? "Height" : "Width";
                  var fixedSize = toPixel(
                    Splide.root,
                    options["fixed" + dimension]
                  );

                  if (fixedSize) {
                    // Roughly calculate the count. This needs not to be strict.
                    baseCount = Math.ceil(
                      Elements.track["client" + dimension] / fixedSize
                    );
                  }

                  return (
                    baseCount * (options.drag ? options.flickMaxPages + 1 : 1)
                  );
                }
                /**
              ...
              /* harmony default export */ const horizontal = function (
                ...
                return {
                   ...
                   */
                  margin:
                    "margin" + (options.direction === RTL ? "Left" : "Right"),
                  ...
                  get width() {
                    return (
                      track.clientWidth - this.padding.left - this.padding.right
                    );
                  },
                };
              ...
              /* harmony default export */ const vertical = function (
                ...
                return {
                  ...
                  totalHeight: function totalHeight(index) {
                    ...
                    if (Slide) {
                      return (
                        getRect(Slide.slide).bottom -
                        getRect(Elements.list).top +
                        this.gap
                      );
                    }
                  ...
                  get height() {
                    var height =
                      options.height || this.width * options.heightRatio;
              ...
              /* harmony default export */ const layout = function (
                ...
                var Layout = object_assign(
                  {
                    ...
                    mount: function mount() {
                      ...
                      this.totalSize = isVertical
                        ? this.totalHeight
                        : this.totalWidth;
                      this.slideSize = isVertical
                        ? this.slideHeight
                        : this.slideWidth;
                    },
                  ...
                  isVertical
                    ? vertical(Splide, Components)
                    : horizontal(Splide, Components)
                );
                /**
                ...
                function resize() {
                  ...
                  var slideHeight = options.autoHeight
                    ? null
                    : unit(Layout.slideHeight());
                  Elements.each(function (Slide) {
              ...
              /* harmony default export */ const drag = function (
                Splide,
                Components
              ) {
                /**
                  ...
                  mount: function mount() {
                    ...
                    Splide.on("touchstart mousedown", start, track)
                      ...
                      .on("mounted refresh", function () {
                        ...
                        each(
                          Elements.list.querySelectorAll("img, a"),
                          function (elm) {
                ...
                function move(e) {
                  if (startInfo) {
                    ...
                    if (isDragging) {
                      ...
                      if (!Splide.is(FADE)) {
                        var position =
                          startCoord[axis] + currentInfo.offset[axis];
                ...
                function shouldMove(_ref) {
                  ...
                  if (
                    ...
                    Splide.options.waitForTransition
                  ) {
                    return false;
                  }

                  var angle =
                    (Math.atan(drag_abs(offset.y) / drag_abs(offset.x)) * 180) /
                    Math.PI;
                ...
                function resist(position) {
                  if (Splide.is(SLIDE)) {
                    ...
                    var _end =
                      sign * Track.trim(Track.toPosition(Controller.edgeIndex));

                    position *= sign;

                    if (position < _start) {
                      position =
                        _start - FRICTION_REDUCER * Math.log(_start - position);
                    } else if (position > _end) {
                      position =
                        _end + FRICTION_REDUCER * Math.log(position - _end);
                    }
                  ...
                  if (absV > 0) {
                    ...
                    if (!Splide.is(FADE)) {
                      ...
                      if (
                        ...
                        drag_abs(info.offset[axis]) <
                          options.swipeDistanceThreshold
                      ) {
                        destination +=
                          sign *
                          Math.min(
               ...
               * @return {Object} - The component object.
               */
              /* harmony default export */ const click = function (
                Splide,
                Components
              ) {
                /**
              ...
              /* harmony default export */ const cover = function (
                Splide,
                Components
              ) {
                /**
                ...
                function apply(uncover) {
                  Components.Elements.each(function (Slide) {
                    var img =
                      child(Slide.slide, "IMG") ||
                      child(Slide.container, "IMG");
              ...
              /* harmony default export */ const arrows = function (
                ...
                function updateDisabled() {
                  ...
                  var isEnough =
                    Splide.length > Splide.options.perPage || Splide.is(LOOP);
                ...
                function appendArrows() {
                  ...
                  var parent =
                    Splide.options.arrows === "slider" && slider
                      ? slider
                      : root;
              ...
              /* harmony default export */ const lazyload = function (
                ...
                function load(img, Slide) {
                  ...
                  setAttribute(
                    img,
                    "srcset",
                    getAttribute(img, SRCSET_DATA_NAME) || ""
                  );
                  setAttribute(
                    img,
                    "src",
                    getAttribute(img, SRC_DATA_NAME) || ""
                  );
                }
                /**
              ...
              /* harmony default export */ const a11y = function (
                Splide,
                Components
              ) {
                /**
                ...
                var A11y = {
                  ...
                  mount: function mount() {
                    ...
                    if (Splide.options.isNavigation) {
                      Splide.on(
                        "navigation:mounted navigation:updated",
                        initNavigation
                      )
                ...
                function initNavigation(main) {
                  Elements.each(function (Slide) {
                    ...
                    var mainSlide =
                      main.Components.Elements.getSlide(slideIndex);
              ...
              /* harmony default export */ const breakpoints = function (
                Splide
              ) {
                /**
                 * Store breakpoints.
        ...
        var r,
          n =
            ((function (e, t) {
              e.exports = (function () {
                var e =
                  new RegExp('^v?(?:\\d+)(?:\\.(?:[x*]|\\d+)(?:\\.(?:[x*]|\\d+)(?:\\.(?:[x*]|\\d+))?(?:-[\\\da-z\\-]+(?:\\.[\\\da-z\\-]+)*)?(?:\\+[\\\da-z\\-]+(?:\\.[\\\da-z\\-]+)*)?)?$', 'i');
                function t(e) {
                  var t,
                ...
                function i(e, i) {
                  ...
                  if (f && h) {
                    ...
                    for (a = 0; a < Math.max(l.length, p.length); a++) {
                      if (
                        void 0 === l[a] ||
                        ("string" == typeof p[a] && "number" == typeof l[a])
                      )
                        return -1;
                      if (
                        void 0 === p[a] ||
                        ("string" == typeof l[a] && "number" == typeof p[a])
                      )
                        return 1;
                      if (l[a] > p[a]) return 1;
                      if (p[a] > l[a]) return -1;
            ...
            return (
              ...
              new Proxy(e, {
                ...
                set: function (e, r, n, c) {
                  ...
                  return (
                    (e[r] = n),
                    i(u) || i(u.__watchers) || (e[r].__watchers = u.__watchers),
                    t.set(e, r, e[r], c),
                    !0
                  );
                },
            ...
            start: function () {
              ...
              this.startingCallbacks.forEach(function (e) {
                ...
                (this.stores = a(this.stores, {
                  get: function (t, r, n) {
                    return Object.is(n, e.stores) &&
                      ["get", "set", "toggle", "call", "clear"].includes(r)
                      ? e[r].bind(e)
                      : Reflect.get(t, r, n);
                  },
            ...
            attach: function () {
              if (
                !(
                  ...
                  (window.Alpine &&
                    n.compare(window.Alpine.version, "2.7.0", ">="))
                )
              )
                throw new Error(
      ...
      (function (window, factory) {
        ...
        function (window, document, lazySizes, initialEvent) {
          ...
          function getObject(element) {
            ...
            var objectPosition =
              (objectFit && content.match(regCssPosition)) || "";
          ...
          function removePrevClone(element) {
            ...
            if (prev && lazySizes.hC(prev, cloneElementClass)) {
              ...
              element.style.visibility =
                prev.getAttribute("data-visibility") || "";
            }
          }
      ...
      (function (window, factory) {
        ...
        function replaceUrlProps(url, options) {
          ...
          url = (
            ...
            url +
            (options.postfix || "")
          ).replace(regPlaceholder, replaceFn);
        ...
        function setSrc(src, opts, elem) {
          ...
          if (opts.ratio === "container") {
            ...
            if (elemW && elemH) {
              opts.ratio = opts.traditionalRatio
                ? elemH / elemW
                : elemW / elemH;
            }
          }
                ...
                records.forEach(function (record) {
                  ...
                  if (record.type === "childList") {
                    ...
                    if (record.attributeName === "tabindex") {
                      ...
                      var inertSubroot =
                        this._inertManager.getInertRoot(target);
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      function accessibleLinks(elements, options) {
        ...
        elements.forEach(function (link) {
          ...
          var missingRelNoopener =
            rel === null || rel.indexOf("noopener") === -1;
      ...
      function getImageSrcset(
        ...
        sizes.forEach((size) => {
          srcset.push(
            `${getSizedImageUrl(src, size.toString() + "x")} ${size}w`
          );
        });
      ...
      function headerIsActive() {
        return (
          document.querySelector(".site-header").classList.contains("active") ||
          false
        );
      }
...
*/
      ...
      function toggleDrawer(drawer, drawerToggle, isOpen) {
        var parentSection =
          drawer.closest(".shopify-section") ||
          drawer.closest("[data-section-type]") ||
          drawer;
          ...
          enableVideo: function enableVideo() {
            ...
            this.$nextTick(function () {
              if (_this2.type === "video") {
                var video =
                  _this2.$refs.video_container.querySelector(".video");
                ...
                if (_this2.host === "youtube") {
                  var youtubeFrame =
                    _this2.$refs.video_container.querySelector(".js-youtube");
                ...
                if (_this2.host === "vimeo") {
                  var vimeoFrame =
                    _this2.$refs.video_container.querySelector(".js-vimeo");
      ...
      register("header", {
        onLoad: function onLoad() {
          ...
          document.documentElement.style.setProperty(
            "--header-height",
            "".concat(
              this.container.clientHeight + announcementBar.clientHeight,
              "px"
            )
          );
          ...
          var overlayHeaderWithSticky =
            this.container.dataset.overlayHeaderWithSticky === "true";
          ...
          window[functionName] = function () {
            return {
                ...
                if (el) {
                  var observer = new IntersectionObserver(function (_ref) {
                    ...
                    e.intersectionRatio === 0
                      ? (_this.headerIsStuck = true)
                      : (_this.headerIsStuck = false);
                  });
                  observer.observe(el);
                }
              ...
              openSearch: function openSearch() {
                if (!this.searchOpen) {
                  var searchInput = this.$el.querySelector(
                    "[data-search-input]"
                  );
              ...
              focusOut: function focusOut(event, menu) {
                if (event.relatedTarget) {
                  var dropdownParent = event.relatedTarget.closest(
              ...
              searchFocusOut: function searchFocusOut(event) {
                if (event.relatedTarget) {
                  var searchParent = event.relatedTarget.closest(
                    "[data-header-search]"
                  );
              ...
              updateHeaderColorScheme: function updateHeaderColorScheme(
                headerIsStuck
              ) {
      ...
      function cartLiveRegion(item) {
        ...
        function _liveRegionContent() {
          ...
          let regularLabel = "";
          let regularPrice = currency_formatMoney(
          ...
          if (item.original_line_price > item.final_line_price) {
            ...
            discountPrice = currency_formatMoney(
      ...
      function variantLiveRegion(variant) {
        ...
        function _liveRegionContent() {
          ...
          if (variant.compare_at_price > variant.price) {
            ...
            regularPrice = currency_formatMoney(
          ...
          window["ThemeSection_cartDrawer"] = function () {
            return {
              ...
              formatMoney: function formatMoney(amount) {
                return Object(currency_cjs["formatMoney"])(
                  amount,
              ...
              qtyAdjust: function qtyAdjust($event, item) {
                ...
                var operation =
                  $event.currentTarget.dataset.qtyAdjust || "plus";
              ...
              getCopyFromLastStateUpdate: function getCopyFromLastStateUpdate(
                item
              ) {
              ...
              updateQuantity: function updateQuantity(item) {
                ...
                var lastQuantity =
                  this.getCopyFromLastStateUpdate(item).quantity || 0;
      ...
      ProductForm.prototype._setIdInputValue = function (value) {
        var idInputElement = this.element.querySelector(
          theme_product_form_selectors.idInput
        );
    ...
    */
          ...
          for (var sectionId in modelJsonSections) {
            if (modelJsonSections.hasOwnProperty(sectionId)) {
              ...
              var modelJson = JSON.parse(
                document.getElementById("ModelJson-" + sectionId).innerHTML
              );
      ...
      const store_availability_StoreAvailability = (function () {
        ...
        function StoreAvailability(container) {
          ...
          this.fetchContent = debounce_default()(
            this.__fetchContent.bind(this),
            500,
            {
              leading: true,
              trailing: true,
        ...
        StoreAvailability.prototype = Object.assign(
          ...
          StoreAvailability.prototype,
          {
            ...
            __fetchContent: function (variant) {
              if (
                window.Spruce.store("availability").availability[variant.id]
              ) {
                ...
                return fetch(variantSectionUrl)
                  ...
                  .then(function (storeAvailabilityHTML) {
                    ...
                    const dataWrapper = html.querySelector(
      ...
      /* harmony default export */ var store_availability =
        store_availability_StoreAvailability;
      ...
      register("product", {
        onLoad: function onLoad() {
          ...
          var storeAvailabilityContainer = this.container.querySelector(
            "[data-store-availability]"
          );
          var variantImageBehaviour =
            this.container.dataset.variantImageBehaviour;
          var isHorizontalGalleryTemplate = this.container.hasAttribute(
          ...
          if (storeAvailabilityContainer) {
            this.storeAvailability = new store_availability(
          ...
          this._debouncedCalculateSlideshowHeight = debounce_default()(
          ...
          this.enableImageZoom =
            this.container.dataset.enableImageZoom === "true" || false;

          if (this.enableImageZoom) {
            Promise.all(
              /* import() | product-image-zoom */ [
                __webpack_require__.e(5),
                __webpack_require__.e(1),
              ]
            )
              .then(__webpack_require__.bind(null, 40))
              .then(function (_ref) {
                var PhotoSwipeModule = _ref["default"];

                _this.setUpImageZoom(
                  PhotoSwipeModule.PhotoSwipe,
                  PhotoSwipeModule.PhotoSwipeUI_Default
                );
              })
          ...
          window[functionName] = function () {
            return {
              ...
              get currentVariantAvailability() {
                ...
                var storeData =
                  window.Spruce.store("availability").availability[id];
              ...
              initProductModels: function initProductModels() {
                var models = section.container.querySelectorAll(
              ...
              mounted: function mounted() {
                ...
                this.getOptions();
                this.changeVariant = debounce_default()(
                  this.__changeVariant,
                  500,
                  {
                    leading: true,
                    trailing: true,
              ...
              __changeVariant: function __changeVariant() {
                var matchedVariant = getVariantFromOptionArray(
                  this.product,
                  this.options
                );
              ...
              getOptions: function getOptions() {
                ...
                this.options = [];
                this.optionHandles = [];
                var selectors = this.$el.querySelectorAll(
              ...
              swapVariantImage: function swapVariantImage() {
                ...
                document.querySelector("[data-first-media]").innerHTML =
                  nextVariantMediaHTML; //scroll back to first slide

                if (
                  section.slides &&
                  section.slides.classList.contains("is-active")
                ) {
              ...
              submitForm: function submitForm(evt) {
                ...
                addItemFromForm(this.$refs.productForm)
                  .then(function (item) {
                    ...
                    ); //dispatch event if cart mode is set to page
              ...
              updateStoreAvailability: function updateStoreAvailability(
                variant
              ) {
        ...
        setupSlideshow: function setupSlideshow(isHorizontalGalleryTemplate) {
          ...
          if (
            ...
            this.slideshowSettings = {
              ...
              breakpoints: {
                1024: {
                  ...
                  arrows: true,
                  drag:
                    this.slides.dataset.dragDisabled == "true" ? false : true,
                  classes: {
            ...
            this.splideContainer = new splide_esm_default.a(
              this.slides,
              this.slideshowSettings
            );
        ...
        setUpImageZoom: function setUpImageZoom(
          PhotoSwipe,
          PhotoSwipeUI_Default
        ) {
          var imageDataEl = this.container.querySelector(
            "[data-product-images]"
          );
          ...
          for (
            var _i = 0, _mediaOrder = mediaOrder;
            _i < _mediaOrder.length;
            _i++
          ) {
          ...
          for (
            var _i2 = 0, _imageDataInOrder = imageDataInOrder;
            _i2 < _imageDataInOrder.length;
            _i2++
          ) {
            ...
            var mobileItem = {
              src: theme_images_getSizedImageUrl(
                imageFullSizeUrl,
                "".concat(mobileWidth, "x")
              ),
              w: mobileWidth,
            ...
            if (imageFullSizeWidth <= desktopMaxWidth) {
              ...
              var desktopSizedImgUrl = theme_images_getSizedImageUrl(
                imageFullSizeUrl,
      ...
      var product_SplideProduct = function SplideProduct(Splide) {
        ...
        function handleMove(newIndex, oldIndex) {
          ...
          newSlide.closest(".splide__track").style.maxHeight =
            newSlideMedia.offsetHeight + "px";
        }
      ...
      /* harmony default export */ var product_recommendations = register(
        ...
        onLoad: function onLoad() {
          ...
          this.splideContainer = new splide_esm_default.a(this.slides, {
            ...
            classes: {
              // Add classes for pagination.
              pagination:
                "splide__pagination absolute inline-block left-0 ml-1 lg:ml-4 bottom-3 w-auto text-current", // container
            },
          });
          this.bindEvents();
        ...
        bindEvents: function bindEvents() {
          ...
          this.splideContainer.on("mounted moved", function () {
            ...
            if (_this.paginationClicked) {
              ...
              var newSlide = elements.getSlide(
                _this.splideContainer.index
              ).slide;
              setTimeout(function () {
                return newSlide.focus({
                  preventScroll: true,
      ...
      /* harmony default export */ var footer = register("footer", {
        onLoad: function onLoad() {
          ...
          if (this.cache.countryDisclosure) {
            this.countryDisclosure = new disclosure(
      ...
      const VideoComponentObserver = (function () {
        ...
        VideoComponentObserver.prototype = Object.assign(
          {},
          VideoComponentObserver.prototype,
          {
            _init: function () {
      ...
      /* harmony default export */ var video_component_observer =
        VideoComponentObserver;
        ...
        _createClass(BackgroundVideo, [
          ...
          },
          {
            ...
            value: function _showErrorMessage(errorMessage) {
              var existingErrorEl = this.container.querySelector(
          ...
          },
          {
            ...
            value: function _onYTPlayerError(e) {
              ...
              switch (e.data) {
                case 2:
                  errorMessage =
                    "Baseline Background Video: Invalid parameter value";
                  break;
          ...
          },
          {
            ...
            value: function _checkContainerSize() {
              ...
              if (containerAspectRatio < videoRatio) {
                ...
                var newWidth = (
                  (videoRatio / containerAspectRatio) *
                  100
                ).toFixed(2);
          ...
          },
          {
            ...
            value: function _initResponsiveVideoContainer() {
              ...
              this._debouncedCheckContainerSize = debounce_default()(
          ...
          },
          {
            ...
            value: function _initVideoContainerObserver() {
              if (
                typeof window.Baseline._videoComponentObserver === "undefined"
              ) {
                window.Baseline._videoComponentObserver =
                  new video_component_observer();
              }
      ...
      /* harmony default export */ var background_video =
        background_video_BackgroundVideo;
      ...
      register("video-with-text-overlay", {
        onLoad: function onLoad() {
          var backgroundVideoEl = this.container.querySelector(
          ...
          window["ThemeSection_collection"] = function () {
            return {
              ...
              mounted: function mounted() {
                ...
                section.container.addEventListener(
              ...
              renderSectionFromFetch: function renderSectionFromFetch(
                url,
                event
              ) {
                var _this3 = this;
                ...
                fetch(url)
                  ...
                  .then(function (responseText) {
                    ...
                    _this3.filterData = [].concat(
                      _toConsumableArray(_this3.filterData),
                      [
                        {
                          html: html,
                          url: url,
              ...
              renderFilters: function renderFilters(html) {
                ...
                var innerHTML = parsedHTML.getElementById(
                  "CollectionFiltersForm"
                ).innerHTML;
                document.getElementById("CollectionFiltersForm").innerHTML =
                  innerHTML;
              },
        ...
        onLoad: function onLoad() {
          ...
          window.ThemeSection_Cart = function () {
            return {
              ...
              getSectionInnerHTML: function getSectionInnerHTML(
                html,
                selector
              ) {
              ...
              updateLiveRegions: function updateLiveRegions(line, itemCount) {
                if (this.currentItemCount === itemCount) {
                  ...
                  var cartErrors =
                    document.querySelectorAll(".cart-item-error");
                ...
                var cartStatus = document.getElementById(
      ...
      function search_toConsumableArray(arr) {
        return (
          search_arrayWithoutHoles(arr) ||
          search_iterableToArray(arr) ||
          search_unsupportedIterableToArray(arr) ||
          search_nonIterableSpread()
        );
      }
          ...
          window["ThemeSection_search"] = function () {
            return {
              ...
              renderSectionFromFetch: function renderSectionFromFetch(
                ...
                fetch(url)
                  ...
                  .then(function (responseText) {
                    var html = responseText;
                    _this3.filterData = [].concat(
                      search_toConsumableArray(_this3.filterData),
                      [
                        {
                          html: html,
                          url: url,
              ...
              renderFilters: function renderFilters(html) {
                ...
                var parsedSearchFiltersForm =
                  parsedHTML.getElementById("SearchFiltersForm");
                var searchFiltersForm =
                  document.getElementById("SearchFiltersForm");

                if (parsedSearchFiltersForm && searchFiltersForm) {
                  searchFiltersForm.innerHTML =
                    parsedSearchFiltersForm.innerHTML;
                }
              },
              renderAdditionalElements: function renderAdditionalElements(
                html
              ) {
                var parsedHTML = new DOMParser().parseFromString(
                  html,
      ...
      register("collapsible", {
        onLoad: function onLoad() {
          ...
          var alpineId = this.container.dataset.alpineId;
          var functionName = "ThemeSection_" + alpineId;
          var singleTabAtATime =
            this.container.dataset.singleTabATime === "true";
          var firstTabOpenOnLoad =
            this.container.dataset.firstTabOpened === "true";
